...
#### 最后，Power Keys 还能让您的笔记本电脑也拥有数字小键盘。我们甚至还提供了两种键位布局，总有一款适合您。

> 即将推出。

<br>

**如果您熟悉数字小键盘的打字指法，请按住 `Caps Lock + Win` 或 `Caps Lock + Alt` 以使用下列布局的数字小键盘。**
...
**如果您不熟悉数字小键盘的打字指法，请按住 `Tab + Win` 或 `Tab + Alt` 以使用下列布局的数字小键盘。**

|按下|即可输入
|:-|:-
|**`7` `8` `9`<br>`U` `I` `O`<br>`J` `K` `L`**|**`7` `8` `9`<br>`4` `5` `6`<br>`1` `2` `3`**
|**`0`**|**`0`**
|**`.`**|**`.`**
|**`Enter`**|**`Enter`**
|**`BackSpace`**|**`BackSpace`**
