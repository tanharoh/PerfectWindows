...
|随同徽标键按下|功能|
|:-|:-|
|**`?`<br>`F1`<br>`F4`<br>`F5`<br><br>**|**显示 Power Keys 的运行状态<br>打开 Power Keys 的帮助页面<br>退出 Power Keys<br>重启 Power Keys 以解决热键失灵问题<br>或者退出游戏模式**
|**`G`<br><br>`F5`**|**进入游戏模式以禁用可能会影响您游戏<br>体验的快捷键和徽标键<br>重启 Power Keys 以退出游戏模式**
|**`+` `-`**|**增大 / 减小系统音量**
